package com.atguigu.gmall.product.controller.v1;
 ...
 */
@RestController
@RequestMapping(value = "/v1/api/category1")
public class Category1ControllerV1 implements ProductApiController {
